...
#################################
      if ($OriginatorZip -eq "$True")
        ...
        if ($OriginatorFiletype.length -gt "2" -or $OriginatorFiletype.length -eq "2")
            {
            ...
            if (($discoveredfilecount -le $OriginatorZipQuantity) -and ($discoveredfilecount -ne 0)) 
                {
...
########################################
                ...
                {
                if ($OriginatorFiletype.length -lt "2" -or $OriginatorFiletype.length -eq "2")
                    {
                    ...
                    if (($discoveredfilecount -le $OriginatorZipQuantity) -and ($discoveredfilecount -ne 0 -or $discoveredfilecount -le 0)) 
                        {
